...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/autogluon.timeseries-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/autogluon.timeseries-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add autogluon.timeseries
# for installing globally
pixi global install autogluon.timeseries
```
...
It is possible to list all of the versions of `autogluon.timeseries` available on your platform:
...
```
pixi search autogluon.timeseries --channel conda-forge
```
